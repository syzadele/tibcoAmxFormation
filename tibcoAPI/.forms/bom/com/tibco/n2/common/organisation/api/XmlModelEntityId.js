 ...
 * This provides an implementation of the class com.tibco.n2.common.organisation.api.XmlModelEntityId. 
 */ 

com.tibco.data.Loader.currentLoader.load("com.tibco.n2.common.organisation.api.qualifierSetType");

com.tibco.data.Loader.classDefiner["com.tibco.n2.common.organisation.api.XmlModelEntityId"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.common.organisation.api.XmlModelEntityId");
...
theClass.TYPE_ARRAY[theClass.ATTR_QUALIFIERSET] = {type:"com.tibco.n2.common.organisation.api.qualifierSetType", baseType:"com.tibco.n2.common.organisation.api.qualifierSetType", primitive:false, multivalued:true, required:false, defaultValue:""};

theClass.PRIMITIVE_ATTRIBUTE_NAMES = [theClass.ATTR_ENTITYTYPE, theClass.ATTR_GUID, theClass.ATTR_QUALIFIER];

theClass.COMPOSITE_ATTRIBUTE_NAMES = [theClass.ATTR_QUALIFIERSET];

theClass.ATTRIBUTE_NAMES = [theClass.ATTR_ENTITYTYPE, theClass.ATTR_GUID, theClass.ATTR_QUALIFIER, theClass.ATTR_QUALIFIERSET];

theClass.getName = function() {
    return "com.tibco.n2.common.organisation.api.XmlModelEntityId";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.common.organisation.api.XmlModelEntityId");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.common.organisation.api.XmlModelEntityId");
};

theClass.prototype.getEntitytype = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlModelEntityId").ATTR_ENTITYTYPE, useInternal);
};

theClass.prototype.setEntitytype = function(entitytype) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlModelEntityId").ATTR_ENTITYTYPE, entitytype);
};


theClass.prototype.getGuid = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlModelEntityId").ATTR_GUID, useInternal);
};

theClass.prototype.setGuid = function(guid) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlModelEntityId").ATTR_GUID, guid);
};


theClass.prototype.getQualifier = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlModelEntityId").ATTR_QUALIFIER, useInternal);
};

theClass.prototype.setQualifier = function(qualifier) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlModelEntityId").ATTR_QUALIFIER, qualifier);
};


theClass.prototype.getQualifierSet = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlModelEntityId").ATTR_QUALIFIERSET);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.common.organisation.api.XmlModelEntityId"]();
