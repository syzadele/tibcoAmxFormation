 ...
 * This provides an implementation of the class com.tibco.n2.common.organisation.api.XmlDynOrgEntityId. 
 */ 

com.tibco.data.Loader.currentLoader.load("com.tibco.n2.common.organisation.api.XmlDynamicIdField");

com.tibco.data.Loader.classDefiner["com.tibco.n2.common.organisation.api.XmlDynOrgEntityId"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.common.organisation.api.XmlDynOrgEntityId");
...
theClass.ATTRIBUTE_NAMES = [theClass.ATTR_DYNAMICIDATTR];

theClass.getName = function() {
    return "com.tibco.n2.common.organisation.api.XmlDynOrgEntityId";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.common.organisation.api.XmlDynOrgEntityId");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.common.organisation.api.XmlDynOrgEntityId");
};

theClass.prototype.getDynamicidattr = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlDynOrgEntityId").ATTR_DYNAMICIDATTR);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.common.organisation.api.XmlDynOrgEntityId"]();
