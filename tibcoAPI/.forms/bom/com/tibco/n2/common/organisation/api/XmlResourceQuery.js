 ...
 * This provides an implementation of the class com.tibco.n2.common.organisation.api.XmlResourceQuery. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.n2.common.organisation.api.XmlResourceQuery"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.common.organisation.api.XmlResourceQuery");
...
theClass.PRIMITIVE_ATTRIBUTE_NAMES = [theClass.ATTR_QUERY];

theClass.COMPOSITE_ATTRIBUTE_NAMES = [];

theClass.ATTRIBUTE_NAMES = [theClass.ATTR_QUERY];

theClass.getName = function() {
    return "com.tibco.n2.common.organisation.api.XmlResourceQuery";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.common.organisation.api.XmlResourceQuery");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.common.organisation.api.XmlResourceQuery");
};

theClass.prototype.getQuery = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlResourceQuery").ATTR_QUERY, useInternal);
};

theClass.prototype.setQuery = function(query) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlResourceQuery").ATTR_QUERY, query);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.common.organisation.api.XmlResourceQuery"]();
