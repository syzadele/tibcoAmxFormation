 ...
 * This provides an implementation of the class com.tibco.n2.common.organisation.api.XmlCalendarAssignment. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.n2.common.organisation.api.XmlCalendarAssignment"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.common.organisation.api.XmlCalendarAssignment");
...
theClass.PRIMITIVE_ATTRIBUTE_NAMES = [theClass.ATTR_CALENDARALIAS, theClass.ATTR_ENTITYGUID];

theClass.COMPOSITE_ATTRIBUTE_NAMES = [];

theClass.ATTRIBUTE_NAMES = [theClass.ATTR_CALENDARALIAS, theClass.ATTR_ENTITYGUID];

theClass.getName = function() {
    return "com.tibco.n2.common.organisation.api.XmlCalendarAssignment";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.common.organisation.api.XmlCalendarAssignment");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.common.organisation.api.XmlCalendarAssignment");
};

theClass.prototype.getCalendaralias = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlCalendarAssignment").ATTR_CALENDARALIAS, useInternal);
};

theClass.prototype.setCalendaralias = function(calendaralias) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlCalendarAssignment").ATTR_CALENDARALIAS, calendaralias);
};


theClass.prototype.getEntityguid = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlCalendarAssignment").ATTR_ENTITYGUID, useInternal);
};

theClass.prototype.setEntityguid = function(entityguid) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.n2.common.organisation.api.XmlCalendarAssignment").ATTR_ENTITYGUID, entityguid);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.common.organisation.api.XmlCalendarAssignment"]();
