 ...
 * This provides an implementation of the class com.tibco.n2.de.api.resolver.describeEntityType. 
 */ 

com.tibco.data.Loader.currentLoader.load("com.tibco.n2.common.organisation.api.XmlDynamicIdField");

com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.resolver.describeEntityType"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.de.api.resolver.describeEntityType");
...
theClass.PRIMITIVE_ATTRIBUTE_NAMES = [theClass.ATTR_ENTITYTYPE, theClass.ATTR_GUID];

theClass.COMPOSITE_ATTRIBUTE_NAMES = [theClass.ATTR_DYNAMICIDATTR];

theClass.ATTRIBUTE_NAMES = [theClass.ATTR_ENTITYTYPE, theClass.ATTR_GUID, theClass.ATTR_DYNAMICIDATTR];

theClass.getName = function() {
    return "com.tibco.n2.de.api.resolver.describeEntityType";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.de.api.resolver.describeEntityType");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.de.api.resolver.describeEntityType");
};

theClass.prototype.getEntitytype = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.n2.de.api.resolver.describeEntityType").ATTR_ENTITYTYPE, useInternal);
};

theClass.prototype.setEntitytype = function(entitytype) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.n2.de.api.resolver.describeEntityType").ATTR_ENTITYTYPE, entitytype);
};


theClass.prototype.getGuid = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.n2.de.api.resolver.describeEntityType").ATTR_GUID, useInternal);
};

theClass.prototype.setGuid = function(guid) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.n2.de.api.resolver.describeEntityType").ATTR_GUID, guid);
};


theClass.prototype.getDynamicidattr = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.n2.de.api.resolver.describeEntityType").ATTR_DYNAMICIDATTR);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.resolver.describeEntityType"]();
