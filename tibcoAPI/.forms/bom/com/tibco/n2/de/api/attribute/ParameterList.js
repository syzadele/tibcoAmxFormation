 ...
 * This provides an implementation of the class com.tibco.n2.de.api.attribute.ParameterList. 
 */ 

com.tibco.data.Loader.currentLoader.load("com.tibco.n2.de.api.XmlLdapAttribute");

com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.attribute.ParameterList"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.de.api.attribute.ParameterList");
...
theClass.TYPE_ARRAY[theClass.ATTR_PARAMETER] = {type:"com.tibco.n2.de.api.XmlLdapAttribute", baseType:"com.tibco.n2.de.api.XmlLdapAttributeSimple", primitive:false, multivalued:true, required:false, defaultValue:""};

theClass.PRIMITIVE_ATTRIBUTE_NAMES = [];

theClass.COMPOSITE_ATTRIBUTE_NAMES = [theClass.ATTR_PARAMETER];

theClass.ATTRIBUTE_NAMES = [theClass.ATTR_PARAMETER];

theClass.getName = function() {
    return "com.tibco.n2.de.api.attribute.ParameterList";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.de.api.attribute.ParameterList");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.de.api.attribute.ParameterList");
};

theClass.prototype.getParameter = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.n2.de.api.attribute.ParameterList").ATTR_PARAMETER);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.attribute.ParameterList"]();
