 ...
 * This provides an implementation of the class com.tibco.n2.de.api.browse.listPrivilegesType. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.browse.listPrivilegesType"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.de.api.browse.listPrivilegesType");
...
theClass.getName = function() {
    return "com.tibco.n2.de.api.browse.listPrivilegesType";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.de.api.browse.listPrivilegesType");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.de.api.browse.listPrivilegesType");
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.browse.listPrivilegesType"]();
