 ...
 * This provides an implementation of the class com.tibco.n2.de.api.ldapservice.listContainerResourcesType. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.ldapservice.listContainerResourcesType"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.de.api.ldapservice.listContainerResourcesType");
...
theClass.getName = function() {
    return "com.tibco.n2.de.api.ldapservice.listContainerResourcesType";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.de.api.ldapservice.listContainerResourcesType");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.de.api.ldapservice.listContainerResourcesType");
};

theClass.prototype.getContainerid = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.n2.de.api.ldapservice.listContainerResourcesType").ATTR_CONTAINERID, useInternal);
};

theClass.prototype.setContainerid = function(containerid) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.n2.de.api.ldapservice.listContainerResourcesType").ATTR_CONTAINERID, containerid);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.ldapservice.listContainerResourcesType"]();
