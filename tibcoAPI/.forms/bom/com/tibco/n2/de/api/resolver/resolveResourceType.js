 ...
 * This provides an implementation of the class com.tibco.n2.de.api.resolver.resolveResourceType. 
 */ 
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.resolver.resolveResourceType"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.de.api.resolver.resolveResourceType");
...
theClass.COMPOSITE_ATTRIBUTE_NAMES = [theClass.ATTR_ENTITY, theClass.ATTR_SELECTIONMODE];

theClass.ATTRIBUTE_NAMES = [theClass.ATTR_ENTITY, theClass.ATTR_SELECTIONMODE];

theClass.getName = function() {
    return "com.tibco.n2.de.api.resolver.resolveResourceType";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.de.api.resolver.resolveResourceType");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.de.api.resolver.resolveResourceType");
};

theClass.prototype.getEntity = function() {
    return this._getComplexAttribute(this.loader.getClass("com.tibco.n2.de.api.resolver.resolveResourceType").ATTR_ENTITY);
};

theClass.prototype.setEntity = function(entity) {
    var classRef = this.loader.getClass("com.tibco.n2.de.api.resolver.resolveResourceType");
...
theClass.prototype.getSelectionmode = function() {
    return this._getComplexAttribute(this.loader.getClass("com.tibco.n2.de.api.resolver.resolveResourceType").ATTR_SELECTIONMODE);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.resolver.resolveResourceType"]();
