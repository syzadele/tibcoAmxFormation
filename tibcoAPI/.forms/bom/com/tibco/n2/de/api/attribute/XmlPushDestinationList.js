 ...
 * This provides an implementation of the class com.tibco.n2.de.api.attribute.XmlPushDestinationList. 
 */ 

com.tibco.data.Loader.currentLoader.load("com.tibco.n2.de.api.attribute.XmlPushDestinationType");

com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.attribute.XmlPushDestinationList"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.de.api.attribute.XmlPushDestinationList");
...
theClass.TYPE_ARRAY[theClass.ATTR_XMLPUSHDESTINATION] = {type:"com.tibco.n2.de.api.attribute.XmlPushDestinationType", baseType:"com.tibco.n2.de.api.attribute.XmlPushDestinationType", primitive:false, multivalued:true, required:false, defaultValue:""};
...
theClass.getName = function() {
    return "com.tibco.n2.de.api.attribute.XmlPushDestinationList";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.de.api.attribute.XmlPushDestinationList");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.de.api.attribute.XmlPushDestinationList");
};

theClass.prototype.getXmlPushDestination = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.n2.de.api.attribute.XmlPushDestinationList").ATTR_XMLPUSHDESTINATION);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.attribute.XmlPushDestinationList"]();
