 ...
 * This provides an implementation of the class com.tibco.n2.de.api.resolver.getEntityNameType. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.resolver.getEntityNameType"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.de.api.resolver.getEntityNameType");
...
theClass.getName = function() {
    return "com.tibco.n2.de.api.resolver.getEntityNameType";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.de.api.resolver.getEntityNameType");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.de.api.resolver.getEntityNameType");
};

theClass.prototype.getGuid = function(useInternal) {
    return this._getPrimitiveArrayAttribute(this.loader.getClass("com.tibco.n2.de.api.resolver.getEntityNameType").ATTR_GUID, useInternal);
};

theClass.prototype.setGuid = function(guid) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.n2.de.api.resolver.getEntityNameType").ATTR_GUID, guid);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.resolver.getEntityNameType"]();
