 ...
 * This provides an implementation of the class com.tibco.n2.de.api.XmlModelEntity. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.XmlModelEntity"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.de.api.XmlModelEntity");
...
theClass.getName = function() {
    return "com.tibco.n2.de.api.XmlModelEntity";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.de.api.XmlModelEntity");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.de.api.XmlModelEntity");
};

theClass.prototype.getName = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.n2.de.api.XmlModelEntity").ATTR_NAME, useInternal);
};

theClass.prototype.setName = function(name) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.n2.de.api.XmlModelEntity").ATTR_NAME, name);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.XmlModelEntity"]();
