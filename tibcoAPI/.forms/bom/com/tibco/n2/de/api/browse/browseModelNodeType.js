 ...
 * This provides an implementation of the class com.tibco.n2.de.api.browse.browseModelNodeType. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.browse.browseModelNodeType"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.n2.de.api.browse.browseModelNodeType");
...
theClass.getName = function() {
    return "com.tibco.n2.de.api.browse.browseModelNodeType";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.n2.de.api.browse.browseModelNodeType");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.n2.de.api.browse.browseModelNodeType");
};
...
com.tibco.data.Loader.classDefiner["com.tibco.n2.de.api.browse.browseModelNodeType"]();
