 ...
 * This provides an implementation of the class com.tibco.bpm.de.api.base.XmlOrgAttribute. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlOrgAttribute"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.bpm.de.api.base.XmlOrgAttribute");
...
theClass.PRIMITIVE_ATTRIBUTE_NAMES = [theClass.ATTR_TYPE, theClass.ATTR_ENUMVAL];

theClass.COMPOSITE_ATTRIBUTE_NAMES = [];

theClass.ATTRIBUTE_NAMES = [theClass.ATTR_TYPE, theClass.ATTR_ENUMVAL];

theClass.getName = function() {
    return "com.tibco.bpm.de.api.base.XmlOrgAttribute";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.bpm.de.api.base.XmlOrgAttribute");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.bpm.de.api.base.XmlOrgAttribute");
};

theClass.prototype.getType = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlOrgAttribute").ATTR_TYPE, useInternal);
};

theClass.prototype.setType = function(type) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlOrgAttribute").ATTR_TYPE, type);
};


theClass.prototype.getEnumval = function(useInternal) {
    return this._getPrimitiveArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlOrgAttribute").ATTR_ENUMVAL, useInternal);
};

theClass.prototype.setEnumval = function(enumval) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlOrgAttribute").ATTR_ENUMVAL, enumval);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlOrgAttribute"]();
