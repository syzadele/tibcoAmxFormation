 ...
 * This provides an implementation of the class com.tibco.bpm.de.api.base.XmlEntityAssignmentQualified. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlEntityAssignmentQualified"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.bpm.de.api.base.XmlEntityAssignmentQualified");
...
theClass.getName = function() {
    return "com.tibco.bpm.de.api.base.XmlEntityAssignmentQualified";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.bpm.de.api.base.XmlEntityAssignmentQualified");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityAssignmentQualified");
};

theClass.prototype.getQualifiervalue = function(useInternal) {
    return this._getPrimitiveArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityAssignmentQualified").ATTR_QUALIFIERVALUE, useInternal);
};

theClass.prototype.setQualifiervalue = function(qualifiervalue) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityAssignmentQualified").ATTR_QUALIFIERVALUE, qualifiervalue);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlEntityAssignmentQualified"]();
