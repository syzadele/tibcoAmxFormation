 ...
 * This provides an implementation of the class com.tibco.bpm.de.api.base.XmlBaseOrgUnit. 
 */ 
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlBaseOrgUnit"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.bpm.de.api.base.XmlBaseOrgUnit");
...
theClass.COMPOSITE_ATTRIBUTE_NAMES = [theClass.ATTR_SCHEMATYPE, theClass.ATTR_ALLOCATIONMETHOD, theClass.ATTR_LOCATIONREF, theClass.ATTR_PRIVILEGEHOLDING, theClass.ATTR_ATTRIBUTE, theClass.ATTR_PUSHDESTINATION];

theClass.ATTRIBUTE_NAMES = [theClass.ATTR_CALENDARALIAS, theClass.ATTR_SCHEMATYPE, theClass.ATTR_ALLOCATIONMETHOD, theClass.ATTR_LOCATIONREF, theClass.ATTR_PRIVILEGEHOLDING, theClass.ATTR_ATTRIBUTE, theClass.ATTR_PUSHDESTINATION];

theClass.getName = function() {
    return "com.tibco.bpm.de.api.base.XmlBaseOrgUnit";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.bpm.de.api.base.XmlBaseOrgUnit");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.bpm.de.api.base.XmlBaseOrgUnit");
};

theClass.prototype.getCalendaralias = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlBaseOrgUnit").ATTR_CALENDARALIAS, useInternal);
};

theClass.prototype.setCalendaralias = function(calendaralias) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlBaseOrgUnit").ATTR_CALENDARALIAS, calendaralias);
};


theClass.prototype.getSchematype = function() {
    return this._getComplexAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlBaseOrgUnit").ATTR_SCHEMATYPE);
};

theClass.prototype.setSchematype = function(schematype) {
    var classRef = this.loader.getClass("com.tibco.bpm.de.api.base.XmlBaseOrgUnit");
...
theClass.prototype.getAllocationmethod = function() {
    return this._getComplexAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlBaseOrgUnit").ATTR_ALLOCATIONMETHOD);
};
...
theClass.prototype.getLocationref = function() {
    return this._getComplexAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlBaseOrgUnit").ATTR_LOCATIONREF);
};
...
theClass.prototype.getPrivilegeholding = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlBaseOrgUnit").ATTR_PRIVILEGEHOLDING);
};
...
theClass.prototype.getAttribute = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlBaseOrgUnit").ATTR_ATTRIBUTE);
};
...
theClass.prototype.getPushdestination = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlBaseOrgUnit").ATTR_PUSHDESTINATION);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlBaseOrgUnit"]();
