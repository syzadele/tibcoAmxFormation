 ...
 * This provides an implementation of the class com.tibco.bpm.de.api.resource.candidateType. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.resource.candidateType"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.bpm.de.api.resource.candidateType");
...
theClass.PRIMITIVE_ATTRIBUTE_NAMES = [theClass.ATTR_CONTAINERID, theClass.ATTR_NAME, theClass.ATTR_LABEL, theClass.ATTR_STARTDATE, theClass.ATTR_ENDDATE];

theClass.COMPOSITE_ATTRIBUTE_NAMES = [];

theClass.ATTRIBUTE_NAMES = [theClass.ATTR_CONTAINERID, theClass.ATTR_NAME, theClass.ATTR_LABEL, theClass.ATTR_STARTDATE, theClass.ATTR_ENDDATE];

theClass.getName = function() {
    return "com.tibco.bpm.de.api.resource.candidateType";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.bpm.de.api.resource.candidateType");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.bpm.de.api.resource.candidateType");
};

theClass.prototype.getContainerid = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.resource.candidateType").ATTR_CONTAINERID, useInternal);
};

theClass.prototype.setContainerid = function(containerid) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.resource.candidateType").ATTR_CONTAINERID, containerid);
};


theClass.prototype.getName = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.resource.candidateType").ATTR_NAME, useInternal);
};

theClass.prototype.setName = function(name) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.resource.candidateType").ATTR_NAME, name);
};


theClass.prototype.getLabel = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.resource.candidateType").ATTR_LABEL, useInternal);
};

theClass.prototype.setLabel = function(label) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.resource.candidateType").ATTR_LABEL, label);
};


theClass.prototype.getStartdate = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.resource.candidateType").ATTR_STARTDATE, useInternal);
};

theClass.prototype.setStartdate = function(startdate) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.resource.candidateType").ATTR_STARTDATE, startdate);
};


theClass.prototype.getEnddate = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.resource.candidateType").ATTR_ENDDATE, useInternal);
};

theClass.prototype.setEnddate = function(enddate) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.resource.candidateType").ATTR_ENDDATE, enddate);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.resource.candidateType"]();
