 ...
 * This provides an implementation of the class com.tibco.bpm.de.api.directory.getCandidateDetailType. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.directory.getCandidateDetailType"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.bpm.de.api.directory.getCandidateDetailType");
...
theClass.getName = function() {
    return "com.tibco.bpm.de.api.directory.getCandidateDetailType";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.bpm.de.api.directory.getCandidateDetailType");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.bpm.de.api.directory.getCandidateDetailType");
};

theClass.prototype.getContainerid = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.directory.getCandidateDetailType").ATTR_CONTAINERID, useInternal);
};

theClass.prototype.setContainerid = function(containerid) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.directory.getCandidateDetailType").ATTR_CONTAINERID, containerid);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.directory.getCandidateDetailType"]();
