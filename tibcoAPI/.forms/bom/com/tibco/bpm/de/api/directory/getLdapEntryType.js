 ...
 * This provides an implementation of the class com.tibco.bpm.de.api.directory.getLdapEntryType. 
 */ 

com.tibco.data.Loader.currentLoader.load("com.tibco.bpm.de.api.directory.attributeType");

com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.directory.getLdapEntryType"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.bpm.de.api.directory.getLdapEntryType");
...
theClass.TYPE_ARRAY[theClass.ATTR_ATTRIBUTE] = {type:"com.tibco.bpm.de.api.directory.attributeType", baseType:"com.tibco.bpm.de.api.directory.attributeType", primitive:false, multivalued:true, required:false, defaultValue:""};

theClass.PRIMITIVE_ATTRIBUTE_NAMES = [];

theClass.COMPOSITE_ATTRIBUTE_NAMES = [theClass.ATTR_ATTRIBUTE];

theClass.ATTRIBUTE_NAMES = [theClass.ATTR_ATTRIBUTE];

theClass.getName = function() {
    return "com.tibco.bpm.de.api.directory.getLdapEntryType";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.bpm.de.api.directory.getLdapEntryType");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.bpm.de.api.directory.getLdapEntryType");
};

theClass.prototype.getAttribute = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.directory.getLdapEntryType").ATTR_ATTRIBUTE);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.directory.getLdapEntryType"]();
