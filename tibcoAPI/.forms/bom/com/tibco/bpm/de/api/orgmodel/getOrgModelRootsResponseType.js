 ...
 * This provides an implementation of the class com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType. 
 */ 
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType");
...
theClass.getName = function() {
    return "com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType");
};

theClass.prototype.getModelversion = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType").ATTR_MODELVERSION, useInternal);
};

theClass.prototype.setModelversion = function(modelversion) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType").ATTR_MODELVERSION, modelversion);
};


theClass.prototype.getCapabilitycategory = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType").ATTR_CAPABILITYCATEGORY);
};
...
theClass.prototype.getCapability = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType").ATTR_CAPABILITY);
};
...
theClass.prototype.getPrivilegecategory = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType").ATTR_PRIVILEGECATEGORY);
};
...
theClass.prototype.getPrivilege = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType").ATTR_PRIVILEGE);
};
...
theClass.prototype.getGroup = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType").ATTR_GROUP);
};
...
theClass.prototype.getLocation = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType").ATTR_LOCATION);
};
...
theClass.prototype.getOrganization = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType").ATTR_ORGANIZATION);
};
...
theClass.prototype.getModeltemplate = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType").ATTR_MODELTEMPLATE);
};
...
theClass.prototype.getResourceattribute = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType").ATTR_RESOURCEATTRIBUTE);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.orgmodel.getOrgModelRootsResponseType"]();
