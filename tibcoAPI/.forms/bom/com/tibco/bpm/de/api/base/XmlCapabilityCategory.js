 ...
 * This provides an implementation of the class com.tibco.bpm.de.api.base.XmlCapabilityCategory. 
 */ 
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlCapabilityCategory"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.bpm.de.api.base.XmlCapabilityCategory");
...
theClass.COMPOSITE_ATTRIBUTE_NAMES = [theClass.ATTR_CAPABILITYCATEGORY, theClass.ATTR_CAPABILITY];

theClass.ATTRIBUTE_NAMES = [theClass.ATTR_CAPABILITYCATEGORY, theClass.ATTR_CAPABILITY];

theClass.getName = function() {
    return "com.tibco.bpm.de.api.base.XmlCapabilityCategory";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.bpm.de.api.base.XmlCapabilityCategory");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.bpm.de.api.base.XmlCapabilityCategory");
};

theClass.prototype.getCapabilitycategory = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlCapabilityCategory").ATTR_CAPABILITYCATEGORY);
};
...
theClass.prototype.getCapability = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlCapabilityCategory").ATTR_CAPABILITY);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlCapabilityCategory"]();
