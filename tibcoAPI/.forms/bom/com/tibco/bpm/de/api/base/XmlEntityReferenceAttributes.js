 ...
 * This provides an implementation of the class com.tibco.bpm.de.api.base.XmlEntityReferenceAttributes. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlEntityReferenceAttributes"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.bpm.de.api.base.XmlEntityReferenceAttributes");
...
theClass.getName = function() {
    return "com.tibco.bpm.de.api.base.XmlEntityReferenceAttributes";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.bpm.de.api.base.XmlEntityReferenceAttributes");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityReferenceAttributes");
};

theClass.prototype.getValue = function(useInternal) {
    return this._getPrimitiveArrayAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityReferenceAttributes").ATTR_VALUE, useInternal);
};

theClass.prototype.setValue = function(value) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityReferenceAttributes").ATTR_VALUE, value);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlEntityReferenceAttributes"]();
