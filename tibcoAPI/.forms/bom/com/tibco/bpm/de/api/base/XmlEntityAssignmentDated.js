 ...
 * This provides an implementation of the class com.tibco.bpm.de.api.base.XmlEntityAssignmentDated. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlEntityAssignmentDated"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.bpm.de.api.base.XmlEntityAssignmentDated");
...
theClass.getName = function() {
    return "com.tibco.bpm.de.api.base.XmlEntityAssignmentDated";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.bpm.de.api.base.XmlEntityAssignmentDated");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityAssignmentDated");
};

theClass.prototype.getStartdate = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityAssignmentDated").ATTR_STARTDATE, useInternal);
};

theClass.prototype.setStartdate = function(startdate) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityAssignmentDated").ATTR_STARTDATE, startdate);
};


theClass.prototype.getEnddate = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityAssignmentDated").ATTR_ENDDATE, useInternal);
};

theClass.prototype.setEnddate = function(enddate) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityAssignmentDated").ATTR_ENDDATE, enddate);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlEntityAssignmentDated"]();
