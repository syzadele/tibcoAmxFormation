 ...
 * This provides an implementation of the class com.tibco.bpm.de.api.base.XmlEntityReferenceDateRange. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlEntityReferenceDateRange"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.bpm.de.api.base.XmlEntityReferenceDateRange");
...
theClass.getName = function() {
    return "com.tibco.bpm.de.api.base.XmlEntityReferenceDateRange";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.bpm.de.api.base.XmlEntityReferenceDateRange");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityReferenceDateRange");
};

theClass.prototype.getStartdate = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityReferenceDateRange").ATTR_STARTDATE, useInternal);
};

theClass.prototype.setStartdate = function(startdate) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityReferenceDateRange").ATTR_STARTDATE, startdate);
};


theClass.prototype.getEnddate = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityReferenceDateRange").ATTR_ENDDATE, useInternal);
};

theClass.prototype.setEnddate = function(enddate) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.bpm.de.api.base.XmlEntityReferenceDateRange").ATTR_ENDDATE, enddate);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.bpm.de.api.base.XmlEntityReferenceDateRange"]();
